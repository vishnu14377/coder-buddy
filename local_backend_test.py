#!/usr/bin/env python3
"""
Local Backend API Testing for Coder Buddy Dashboard
Tests all API endpoints locally since public URL has issues
"""
...
class LocalCoderBuddyAPITester:
    ...
    def test_root_endpoint(self):
        ...
        try:
            ...
            if response.status_code == 200:
                data = response.json()
                if "message" in data and "Coder Buddy" in data["message"]:
    ...
    def run_all_tests(self):
        ...
        print("🚀 Starting Local Coder Buddy Backend API Tests")
        print("=" * 60)
...
def main():
    """Main test execution"""
    tester = LocalCoderBuddyAPITester()
